...
import { settingsScreenLastUpdatedAtInfoTitle } from "@MELocalization/languages/en";
  ...
  return (
    ...
    moment(updatedAt).isValid() && (
      <p className="text-sm text-primary/500 font-medium">
        {_.upperFirst(
          t("settingsScreenLastUpdatedAtInfoTitle", {
            defaultValue: settingsScreenLastUpdatedAtInfoTitle,
          })
        )}
