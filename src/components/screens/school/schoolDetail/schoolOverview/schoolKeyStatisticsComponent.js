...
const SchoolKeyStatisticsComponent = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-5">
      <Card className="border-primary/10 bg-gradient-to-br from-primary to-primary/90 text-white transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-[1.00] cursor-pointer">
