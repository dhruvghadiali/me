...
const checkboxLabelClassNameByVariant = (
  variant = ME_CHECKBOX_COMPONENT_VARIANTS.PRIMARY
) => {
  const variantColorMap = {
    [ME_CHECKBOX_COMPONENT_VARIANTS.PRIMARY]: "primary",
    [ME_CHECKBOX_COMPONENT_VARIANTS.SECONDARY]: "secondary",
    [ME_CHECKBOX_COMPONENT_VARIANTS.SUCCESS]: "success",
    [ME_CHECKBOX_COMPONENT_VARIANTS.WARNING]: "warning",
    [ME_CHECKBOX_COMPONENT_VARIANTS.DANGER]: "danger",
    [ME_CHECKBOX_COMPONENT_VARIANTS.DARK]: "dark",
  };
